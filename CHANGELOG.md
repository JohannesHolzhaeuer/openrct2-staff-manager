...
* checkout release commit sha instead of draft-only tag ref in publish-release ([#17](https://github.com/JohannesHolzhaeuer/openrct2-staff-manager/issues/17)) ([4642031](https://github.com/JohannesHolzhaeuer/openrct2-staff-manager/commit/4642031))
